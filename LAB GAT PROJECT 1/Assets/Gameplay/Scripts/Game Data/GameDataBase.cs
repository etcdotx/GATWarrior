...
public class GameDataBase: MonoBehaviour {
    ...
    public void addQuestSource1()
    {
        ...
        CollectionQuest quest2 = new CollectionQuest(1, 2, 3, 6, "Quest/Cube", "Gather 6 Cube", "Gather", "Gather 6 cube in town", false);
        ...
        CollectionQuest quest4 = new CollectionQuest(1, 4, 5, 8, "Quest/Cube", "Gather 8 Cube", "Gather", "Gather 8 cube in town", false);
        QuestDataBase.collectionQuest.Add(quest4);

        CollectionQuest quest5 = new CollectionQuest(1, 5, 6, 5, "Quest/Cube", "Collect 5 Cube", "Collect", "Collect 5 cube in town", false);
        QuestDataBase.collectionQuest.Add(quest5);

        CollectionQuest quest6 = new CollectionQuest(1, 6, 7, 6, "Quest/Cube", "Gather 6 Cube", "Gather", "Gather 6 cube in town", false);
        QuestDataBase.collectionQuest.Add(quest6);

        CollectionQuest quest7 = new CollectionQuest(1, 7, 8, 7, "Quest/Cube", "Collect 7 Cube", "Collect", "Collect 7 cube in town", false);
        QuestDataBase.collectionQuest.Add(quest7);

        CollectionQuest quest8 = new CollectionQuest(1, 8, 9, 8, "Quest/Cube", "Gather 8 Cube", "Gather", "Gather 8 cube in town", false);
        QuestDataBase.collectionQuest.Add(quest8);

        CollectionQuest quest9 = new CollectionQuest(1, 9, 10, 7, "Quest/Cube", "Collect 7 Cube", "Collect", "Collect 7 cube in town", false);
        QuestDataBase.collectionQuest.Add(quest9);

        CollectionQuest quest10 = new CollectionQuest(1, 10, 0, 8, "Quest/Cube", "Gather 8 Cube", "Gather", "Gather 8 cube in town", false);
