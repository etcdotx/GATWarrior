...
Shader "Shader Forge/ToonLit" {
    Properties {
        ...
        _node_2686 ("node_2686", Float ) = 0
        _node_7941 ("node_7941", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _node_2686;
            uniform float _node_7941;
...
////// Emissive:
                ...
                float3 finalColor = emissive + lerp((node_5551*_ShadowDarkness),node_5551,(((round((Out*node_7029))/node_7029)*_node_7941)*_LightColor0.rgb*attenuation*_node_2686));
...
////// Lighting:
                ...
                float Out = max(0,dot(lightDirection,normalDirection));
                float node_7029 = (_Tone-1.0);
                float3 finalColor = lerp((node_5551*_ShadowDarkness),node_5551,(((round((Out*node_7029))/node_7029)*_node_7941)*_LightColor0.rgb*attenuation*_node_2686));
